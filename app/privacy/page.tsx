  ...
  return (
    <div className="page-shell">
      ...
      <div style={{ fontSize: 14, lineHeight: 1.8, color: "var(--ink-soft)" }}>
        ...
        <p>
          知行 AI 秘书仅收集您主动输入的日程、待办事项等信息。这些数据存储在您的设备本地
          以及您选择的云服务（Cloudflare D1）中。
        </p>
        ...
        <p>
          ...
          您输入的文字内容会被发送到您配置的 AI 服务商（如 DeepSeek、OpenAI 等）进行处理。
        </p>
        <p>除此之外，您的数据不会与任何第三方共享。</p>

        <h3 style={{ marginTop: 16, color: "var(--ink)" }}>3. 数据存储</h3>
        <p>数据存储在 Cloudflare D1 数据库中（亚洲区域）。您可以随时通过设置页面导出或删除您的数据。</p>
